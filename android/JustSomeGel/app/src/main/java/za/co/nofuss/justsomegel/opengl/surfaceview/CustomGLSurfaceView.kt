...
import za.co.nofuss.justsomegel.opengl.OpenGLShape
import za.co.nofuss.justsomegel.opengl.createGLESProgram
import za.co.nofuss.justsomegel.opengl.shapes.Triangle
...
class CustomGLSurfaceView : GLSurfaceView {
    ...
    constructor(context: Context?): super(context) {
        ...
        scaleGestureDetector = ScaleGestureDetector(this.context, object :
